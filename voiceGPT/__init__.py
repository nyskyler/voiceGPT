...
def create_app():
  ...
  #블루프린트
  from .views import main_views, content_views, eval_views, auth_views, comment_views, vote_views, chatgpt_views, topic_views, userImage_views, textgpt_views, cloudstroage_views, neis_views
